...
<TypeTable>
  <TypeTableRow name="string" type="String" description="Handles text-based input." />
  <TypeTableRow name="number" type="Integer/Float" description="Accepts numerical values, both integers and floats." />
  <TypeTableRow name="date" type="Date" description="Requires date format input." />
</TypeTable>
