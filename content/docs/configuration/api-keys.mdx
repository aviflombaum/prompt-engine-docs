---
title: API Keys
description: "How to securely store your LLM API Keys"
icon: SettingsIcon
order: 2
---
...
<figure>
  <img src="/images/settings.png" alt="Settings" style={{ borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', maxWidth: '100%' }} />
